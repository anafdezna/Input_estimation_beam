...
folder_name  = 'May27_SingleNode5Load_sensorsat1_400timepoints_1sensors_9modes_0.001LR_20000epochs'
...
weights_path = os.path.join(folder_path, "Weights_ae.h5" )
...
ax.set_ylabel(r'ü(t) [m/s²] at sensor $s_{1}$') # y-label remains appropriate
