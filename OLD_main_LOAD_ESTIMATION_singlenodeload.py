...
# -*- coding: utf-8 -*-
"""
Created on Sun Jun  1 16:19:40 2025
...
def main():
    ...
    # Loaded nodes: 
    # load_locs = [2,6] # DOF identifier of the loaded nodes. 
    ...
    # sensor_locs_tensor = [1] #for three specific DOFS instruementd
    ...
    heading ='Jun01prueba_sensorsatAllnodes'
